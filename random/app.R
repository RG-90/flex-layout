...
ui <- fluidPage(
    titlePanel("Example shiny dashboard"),
    
    sidebarLayout(
        sidebarPanel(
            h5("Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
               sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
               Purus ut faucibus pulvinar elementum integer. Commodo odio aenean sed 
               adipiscing diam donec adipiscing tristique. Tempus egestas sed sed risus pretium. 
               Sit amet venenatis urna cursus eget nunc scelerisque viverra. Vitae tempus quam pellentesque nec nam. 
               Nisl nisi scelerisque eu ultrices vitae auctor eu. Velit scelerisque in dictum non consectetur a")
        ),

        # Show a plot of the generated distribution
        mainPanel(
           h3("cursus eget nunc strongscelerisque viverra"),
           plotly5
        )
    ),
    sidebarLayout(
    ...
    verticalLayout(
        plotly7, 
        wellPanel("Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
               sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
               Purus ut faucibus pulvinar elementum integer. Commodo odio aenean sed 
               adipiscing diam donec adipiscing tristique. Tempus egestas sed sed risus pretium. 
               Sit amet venenatis urna cursus eget nunc scelerisque viverra. Vitae tempus quam pellentesque nec nam. 
